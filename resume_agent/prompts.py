...
GENERATE_PROJECTS_SYSTEM = (
    ...
    "Rules:\n"
    "1. Output ONLY LaTeX code - no explanations, no markdown, no comments\n"
    "2. Each project must have 2 bullets ONLY with 2-3 lines max\n"
    "3. Each bullet is ONE sentence starting with action verb (Developed, Engineered, Built, Designed, Implemented, Created, Streamlined, Spearheaded, Collaborated)\n"
    ...
    "10. Generate exactly 2 projects with 2 bullets each with 2-3 lines max\n"
...
GENERATE_PROJECTS_USER = (
    ...
    "LaTeX Format Template:\n{format_template}\n\n"
    "Generate exactly 2 projects with 2 bullets each. "
